...
async function render() {
  ...
  const rules=activeDayRules(s.settings),quotaRemaining=Math.max(0,rules.limit+(Number(rewardUse.quotaMinutes)||0)-used);document.querySelector('#status').textContent=rules.name||'本機'; let clockRemaining=null;
